...
if( choiceNumber == 1 && _storyNumber == 0){
 ...
 }else if ( choiceNumber == 1 && _storyNumber == 2)
 {
   ...
   print('_storyNumber = $_storyNumber');
    ...
    _storyNumber = 3;
    print('_storyNumber = $_storyNumber');
} else if ( choiceNumber == 1 || choiceNumber == 2 && _storyNumber == 3){
    restart();
}  else if ( choiceNumber == 1 || choiceNumber == 2 && _storyNumber == 4){
  restart();
}  else if ( choiceNumber == 1 || choiceNumber == 2 && _storyNumber == 5){
  restart();
}
